...
![file command output showing ELF 64-bit statically linked stripped binary](../Screenshots/Crackmes1/01-file-output.png)
...
![strings output showing user-facing messages including the flag and a hint](../Screenshots/Crackmes1/02-strings-output.png)
...
![ImHex strings view showing the serial at offset 0x8700E alongside the user-facing messages](../Screenshots/Crackmes1/03-hex-rodata.png)
...
![Terminal showing the binary accepting CRACKME-12345-EDU and printing the flag](../Screenshots/Crackmes1/04-success.png)
